...
let $ScreenEvent$MouseDragged$Post = Java.loadClass('net.minecraftforge.client.event.ScreenEvent$MouseDragged$Post')
let $ScreenEvent$MouseScrolled$Post = Java.loadClass('net.minecraftforge.client.event.ScreenEvent$MouseScrolled$Post')
let $ScreenEvent$MouseButtonPressed$Post = Java.loadClass('net.minecraftforge.client.event.ScreenEvent$MouseButtonPressed$Post')
let $ScreenEvent$CharacterTyped$Post = Java.loadClass('net.minecraftforge.client.event.ScreenEvent$CharacterTyped$Post')
let $ScreenEvent$KeyPressed$Post = Java.loadClass('net.minecraftforge.client.event.ScreenEvent$KeyPressed$Post')
