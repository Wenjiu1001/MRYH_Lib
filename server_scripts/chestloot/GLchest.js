...
LootJS.modifiers((event) => {
  ...
  event.addLootTypeModifier(LootType.CHEST)
      ...
      .apply((context) => {
          ...
          context.addLoot(
              LootEntry.of(getRandomItemMod(), getRandomNumber(1, 3))
                  .withChance(getRandomChance(0.1, 0.7))
  ...
  event.addLootTypeModifier(LootType.CHEST)
      ...
      .apply((context) => {
          context.addLoot(
              LootEntry.of('tacz:ammo', 1, { AmmoId: getRandomAmmo() })
                  .withChance(getRandomChance(0.1, 0.7))
                  .when((c) => c.randomChance(0.7))
          );
          context.addLoot(
              LootEntry.of('tacz:ammo', 1, { AmmoId: getRandomAmmoMod() })
                  .withChance(getRandomChance(0.1, 0.7))
                  .when((c) => c.randomChance(0.3))
          );
      });
  ...
  event.addLootTypeModifier(LootType.CHEST)
      ...
      .apply((context) => {
          ...
          context.addLoot(
              LootEntry.of(getRandomHarmorGraduation(), 1)
                  .withChance(getRandomChance(0.1, 0.7))
                  .when((c) => c.randomChance(0.1))
          );
          context.addLoot(
